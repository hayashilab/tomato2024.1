...
class DetectionPublisher:
    def __init__(self, video_path):
        ...
        # Set up YOLO model, video capture, and CvBridge
        self.model = YOLO("best_tomato2024.pt")
        self.names = self.model.model.names
        self.cap = cv2.VideoCapture(video_path)
        self.bridge = CvBridge()
        
        # Set timer for callback execution rate
    ...
    def timer_callback(self, event):
        ...
        if not ret:
            ...
            rospy.signal_shutdown("End of video or failed to read frame.")
            return
    ...
    def publish_detected_area(self, detected_area):
        ...
        rospy.loginfo("Published detected area.")
    ...
    def publish_original_frame(self, original_frame):
        ...
        rospy.loginfo("Published original frame.")
    ...
    def publish_all_detected_mask(self, all_detected_mask):
        ...
        rospy.loginfo("Published all detected mask.")
    ...
    def publish_centroid_difference(self, diff_x, diff_y):
        ...
        rospy.loginfo(f"Published centroid difference: x={diff_x}, y={diff_y}")


def main():
    video_path = 'testAll.mp4'  # Update this with your video file path
